...
public class SeleniumUtil {
	...
	public static void launchApplication() {
		...
		driver.get(SeleniumUtil.getConfigProperties().getProperty("VCMUrl"));
	}
	...
	public static void validateWebElementVisible(By by) {
		LOGGER.info("Inside ValidateWebElementPresence method");
		objExplicitWait(waitWebElementSync).until(ExpectedConditions.visibilityOfElementLocated(by));
	...
	public static void waitWebElementClickable(By by) {
		LOGGER.info("Inside ValidateWebElementPresence method");
		objExplicitWait(waitWebElementSync).until(ExpectedConditions.elementToBeClickable(by));

	}
	
	public static String getDefaultSelection(By by) {
		LOGGER.info("Inside getDefaultSelection method");
	...
	public static void selectWebList(By by, String val, String selectBy) {
		LOGGER.info("Inside selectWebList method");
		WebElement wb = driver.findElement(by);
		Select sel = new Select(wb);
	...
	public static void clickWebElement(By by) {
		LOGGER.info("inside clickWebElement method");
		validateWebElementVisible(by, waitWebElementSync);
		waitWebElementClickable(by, waitWebElementSync);
		getWebElement(by).click();

	}
	public static void enterText(By by,String text) {
		LOGGER.info("inside enterText method");
		validateWebElementVisible(by, waitWebElementSync);
		waitWebElementClickable(by, waitWebElementSync);
	...
	public static String getText(By by) {
		LOGGER.info("inside getText method");
   ...
   Logs log= driver.manage().logs();
	...
	public static void uploadFile(By by,String filepath) throws Throwable {
		getWebElement(by).click();
		
		File file = new File(System.getProperty("user.dir")+"/src/test/resources/Upload/"+filepath);
		String path = file.getAbsolutePath();
		System.out.println("printt image path"+path);
		//String path="https://aucdt.edu.gh/img/AUCDT-Logo-for-Website.png";
		System.out.println("path of file "+path);
		wait(2000);
		robotUploadFile(path);
	}
